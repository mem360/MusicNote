...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MusicNote Demo Installer\n"
      else:
        line="OutputBaseFilename=MusicNote Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MusicNote Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MusicNote installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MusicNote Demo installer\n"
     else:
       line="SetupWindowTitle=MusicNote installer\n"
