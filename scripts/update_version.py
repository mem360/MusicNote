...
def main():
  ...
  plistpath = scriptpath + "/resources/MusicNote-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MusicNote-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MusicNote-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MusicNote-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MusicNote-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/MusicNote.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MusicNote.iss",inplace=1):
