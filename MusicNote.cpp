...
MusicNote::MusicNote(const InstanceInfo& info)
...
#if IPLUG_DSP
void MusicNote::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void MusicNote::OnIdle()
{
  mMeterSender.TransmitData(*this);
  mLFOVisSender.TransmitData(*this);
}

void MusicNote::OnReset()
{
  mDSP.Reset(GetSampleRate(), GetBlockSize());
}

void MusicNote::ProcessMidiMsg(const IMidiMsg& msg)
{
  TRACE;
...
void MusicNote::OnParamChange(int paramIdx)
{
  mDSP.SetParam(paramIdx, GetParam(paramIdx)->Value());
}

bool MusicNote::OnMessage(int msgTag, int ctrlTag, int dataSize, const void* pData)
{
